...
1. Position of the mutation (coding, intron, fiveUTR, threeUTR, intron, intergenic, spliceSite, promoter)
2. Consequence on the protein for coding mutations (nonsynonymous, synonymous, frameshift, stop) with eventual change in the AA
3. Synonymous mutations are then compared to known driver genes from the intogen database and flagged as drivers
...
if(!require(tx_pkg, character.only = TRUE))
  BiocManager::install(tx_pkg, site_repository = )
