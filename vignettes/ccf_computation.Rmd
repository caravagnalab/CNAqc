...
We know the [relation between VAF, mutation multiplicity and tumour purity](https://caravagn.github.io/CNAqc/articles/CNAqc.html). In this task we determine the value of $m$ from the observed $v$, the karyotype and tumour purity. 
...
```{r,fig.width=9.5, fig.height=9,  warning=F, message=F}
